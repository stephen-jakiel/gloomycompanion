...
MACROS =
    ...
    , "%aoe-3-side-with-black%":                    "<img class='aoe h2' src='images/aoe-3-side-with-black.svg'>"
    ...
    , "%elite%":                                    "<span class='elite-color'>ELITE:</span>"
    ...
    , "%regenerate%":                               "<span class='nobr'>REGENERATE <img class='icon' src='images/regenerate.png'></span>"
    ...
    , "%teleport%":                                 "<span class='nobr'>Teleport <img class='icon' width='30' height='28' src='images/teleport.png'></span>"
